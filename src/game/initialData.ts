...
export const initialFurniture: FurnitureItem[] = [
  ...
  },
  {
    ...
    color: '#26262B',
    selected: false,
    idealPosition: { x: 0, y: 0.739, z: -1.005 },
    idealRotation: { x: 0, y: 0, z: 0 },
    tolerancePos: 0.06, toleranceRot: 8,
  ...
  },
  {
    ...
    color: '#1F1F24',
    selected: false,
    idealPosition: { x: 0.35, y: 0.744, z: -1.005 },
    idealRotation: { x: 0, y: 0, z: 0 },
    tolerancePos: 0.07, toleranceRot: 15,
    heightAdjustable: false, minHeight: 0.6, maxHeight: 0.9,
  ...
  },
  {
    ...
    name: 'Lampu Meja',
    type: 'lamp',
    position: { x: 0.10, y: 0.89, z: -1.40 }, // masih di tengah → silau
    rotation: { x: 0, y: 0, z: 0 },
    scale: { x: 0.05, y: 0.30, z: 0.05 },
    color: '#E9B949',
    selected: false,
    idealPosition: { x: 0.55, y: 0.89, z: -1.23 }, // kanan pemain, pojok kanan-depan meja
    idealRotation: { x: 0, y: 0, z: 0 },
